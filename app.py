...
class testabusive(Resource):
	def get(self, user_index):
		...
		config = {
							"apiKey": "AIzaSyDSBdRBPURQc9-_ijNH_a5VozR3Y7xwVjM",
							"authDomain": "televital-euvsvirusv2.firebaseapp.com",
							"databaseURL": "https://televital-euvsvirusv2.firebaseio.com",
							"projectId": "televital-euvsvirusv2",
							"storageBucket": "televital-euvsvirusv2.appspot.com",
							"messagingSenderId": "812820959837",
							"appId": "1:812820959837:web:2cbe1c95205436ba7673b4"
		...
		B=5
		bo = 0.0
		nm = db.child("Vitals").child(user_index).get()
		res= nm.val()
		...
		db.child("Vitals").child(user_index).update({"sp":spresult})
		return (1)
